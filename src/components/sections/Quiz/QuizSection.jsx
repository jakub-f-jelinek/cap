...
import {
  ...
  LEFT_GLASS_MOTION_2,
  LEFT_GLASS_MOTION_3,
  RIGHT_GLASS_MOTION_1,
  RIGHT_GLASS_MOTION_2,
  RIGHT_GLASS_MOTION_3,
  ...
  return (
    <section id="test" className="quiz-section section">
      ...
      <div className="container quiz-section__inner">
        ...
        {started && (
          <>
            <div className="quiz-section__controls">
              <div
              ...
              <div className="quiz-section__nav-row">
                <div className="btn__container btn__container--prev">
                  <button
                    type="button"
                ...
                <div className="btn__container btn__container--next">
                  <button
                    type="button"
