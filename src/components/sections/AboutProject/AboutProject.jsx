        ...
        <div className="about-project__intro">
          ...
          <div className="about-project__intro-text">
            <p>
              ...
              následky. Na tyto aktivity navazuje kampaň Normální řízení
              zabíjí. Kampaň upozorňuje na přestupky, které si za volantem
              omlouváme a&nbsp;považujeme za běžné. Chce vést řidiče
              k&nbsp;přehodnocení vlastních návyků: ani chování, na které
              jsme zvyklí, nemusí být bezpečné.
            </p>
            <p>
              Součástí projektu je celovečerní dokument Jediná vteřina
              režiséra Víta Klusáka. Prostřednictvím skutečných příběhů
              ukazuje, jak mohou rozhodnutí za volantem nevratně zasáhnout do
              života řidičů, obětí i&nbsp;jejich blízkých. Dává tak tématu
              konkrétní lidský rozměr a&nbsp;prostor k&nbsp;zamyšlení nad
              vlastní odpovědností.
            </p>
            <p>
              Česká asociace pojišťoven spolupracuje na projektu
              s&nbsp;Policií ČR. Projekt je podpořen z&nbsp;prostředků Fondu
