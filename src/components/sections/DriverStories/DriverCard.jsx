import portrait from '@/assets/images/person-card-1.png'
      ...
      <div className="driver-card__inner">
        <div className="driver-card__front">
          ...
          <div className="driver-card__front-footer">
            ...
            <p className="driver-card__teaser">{driver.teaser}</p>
          </div>
        </div>

        <div className="driver-card__back">
          <p className="driver-card__name driver-card__name--dark">{driver.name}</p>
